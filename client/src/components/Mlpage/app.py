...
model=pickle.load(open("C:\Sathi-main\Sathi-main\client\src\components\Mlpage\model_1.pkl",'rb'))
...
def predict():
    ...
    image_path = "C:\Sathi-main\Sathi-main\client\src\components\Mlpage\images"+imagefile.filename
